...
@section('desc', 'Dihalaman ini anda bisa membuat pendaftaran siswa.')
@section('content')
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('nama_siswa') }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('agama') }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="program" id="program"
                                ...
                                <option value="INTENSIF" {{ old('program') == 'INTENSIF' ? 'selected' : '' }}>Intensif
                                </option>
                                <option value="REGULER" {{ old('program') == 'REGULER' ? 'selected' : '' }}>Reguler
                                </option>
                                <option value="AKADEMIK" {{ old('program') == 'AKADEMIK' ? 'selected' : '' }}>Akademik
                                </option>
                                <option value="PSIKOLOGI" {{ old('program') == 'PSIKOLOGI' ? 'selected' : '' }}>
                                    Psikologi</option>
                            </select>
                            @error('program')
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('pengiriman') }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('no_telfon_siswa') }}" type="text"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('pekerjaan_ayah') }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('pekerjaan_ibu') }}" type="text"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input value="{{ old('no_telfon_orang_tua') }}" type="text"
